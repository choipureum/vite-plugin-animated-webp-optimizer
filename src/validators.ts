...
export function validateOptions(options: AnimatedWebpOptimizerOptions = {}): void {
...
export function mergeOptions(options: AnimatedWebpOptimizerOptions = {}): Required<AnimatedWebpOptimizerOptions> {
